...
const ExploreStores = () => {
  const allStores = [
    {
      ...
      description: "Your one-stop shop for all electronic devices.",
    ...
    },
    {
      ...
      whatsappBusinessId: "1234567891",
    },
    {
      id: 3,
      name: "Tech Haven",
      description: "Find everything tech-related here.",
      whatsappBusinessId: "1234567892",
    },
    {
      id: 4,
      name: "Smart Home Supplies",
      description: "Smart home devices and more.",
      whatsappBusinessId: "1234567893",
    },
    // Add more stores as needed
  ];
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold">Explore Shops</h1>
      <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {allStores.map((store) => (
          <div key={store.id} className="bg-white p-4 shadow rounded-lg">
