...
// import ElectronicsStore from "../public/electronshop.jpg";
// import FruitStore from "../public/fruitstore.jpg";
// import CakesBakesStore from "../public/caes-baes.jpg";
// import ClothesStore from "../public/clothestore.jpg";
// import GroceryStore from "../public/grocerystore.jpg";
...
//   {
//     id: 3,
//     name: "Cakes & Bakes Store",
//     image: CakesBakesStore,
//     price: 2.5,
//     stock: 10,
//   },
//   {
...
// // export default ProductCard; <Link href={`/stores-categories/${product.name.toLowerCase().replace(/\s+/g, '-')}`}>
...
//       <div className="bg-[#dcb373] md:py-4 py-2  flex justify-between items-center md:px-6 px-2 ">
//         <h2 className="text-xl font-bold text-white">Stores by Category</h2>
//         {
//           /* <Link
//           href="/new-arrivals"
...
const newArrivals = [
  ...
  },
  {
    ...
    price: 2.5,
    stock: 10,
    category: "cakes-and-bakes", // Added category
  },
  {
    id: 4,
    name: "Clothes Store",
    ...
    price: 2.5,
    stock: 10,
    category: "clothes", // Added category
  },
  {
    id: 5,
    name: "Grocery Store",
...
const ProductCard = ({ product }) => {
  return (
    // <Link href={`/categories/${product.id}`}>
    <Link key={product.id} href={`/categories/${product.category}`}>
      <div className="relative w-full h-64 rounded-lg shadow overflow-hidden cursor-pointer">
        <Image
          src={product.image}
          alt={product.name}
          layout="fill"
...
const NewArrivals = () => {
  return (
    <section id="new-arrivals" className="relative">
      <div className=" bg-gradient-to-l from-[#557C56] to-[#3D593E] md:py-4 py-2 flex justify-between items-center md:px-6 px-2">
        <h2 className="text-xl font-bold text-white">Stores by Category</h2>
        <Link
          href="/stores-categories"
          className="md:bg-[#528353] bg-inherit text-white px-4 py-2 rounded flex items-center hover:bg-inherit md:hover:bg-[#916826] transition"
        >
          <span className="hover:underline text-[#dcb373]">View All</span>
          <svg
            className="ml-0 w-4 h-4 text-[#dcb373]"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
