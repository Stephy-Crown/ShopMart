...
const BusinessLoginForm = () => {
  ...
  return (
    <div className="w-full max-w-[85vw] lg:max-w-md p-8 space-y-4 bg-white rounded-xl shadow-lg mt-10">
      <h2 className="text-lg lg:text-2xl font-bold text-center text-[#3D593E] lg:pt-4">
        Login to your Business Account
      </h2>
      <form
        onSubmit={handleLogin}
        className="space-y-4 lg:space-y-6 pb-5 lg:pb-10"
      >
        <div>
          <label className="block mb-2 text-sm font-medium text-[#3D593E]">
            Business Email
          </label>
          <input
            type="email"
        ...
        <button
          type="submit"
          className="w-full flex justify-center px-4 pt-2 pb-3 font-medium text-white hover:bg-gradient-to-r hover:from-[#234c72] hover:to-[#3b7cb8] bg-gradient-to-r from-[#557C56] to-[#3D593E] hover:bg-[##3D593E] hover:bg-[#21578e] rounded focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
          {loadingEmail ? (
            <div className="border-2 border-gray-300 border-t-2 border-t-transparent rounded-full w-5 h-5 spinner"></div>
          ) : (
      ...
      <div className="flex items-center justify-center space-x-4">
        <div className="h-px w-16 bg-[#3D593E]"></div>
        <span className="text-sm text-[#3D593E]">OR</span>
        <div className="h-px w-16 bg-[#b8d0b8]"></div>
      </div>
      <button
        onClick={handleGoogleLogin}
        className="w-full flex justify-center px-4 py-2 font-medium text-white bg-red-600 hover:bg-red-700 rounded focus:outline-none focus:ring-2 focus:ring-red-500"
      >
        {loadingGoogle ? (
          ...
          <div className="text-white">Login with yourGoogle</div>
        )}
      </button>
